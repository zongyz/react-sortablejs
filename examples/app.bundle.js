...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSortablejs = __webpack_require__(159);

	var _reactSortablejs2 = _interopRequireDefault(_reactSortablejs);

	var _simpleList = __webpack_require__(161);

	var _simpleList2 = _interopRequireDefault(_simpleList);

	var _sharedGroup = __webpack_require__(162);

	var _sharedGroup2 = _interopRequireDefault(_sharedGroup);
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            'div',
	            { className: 'title', style: { marginTop: 100 } },
	            'Shared Group'
	        ),
	        _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement(
	                'div',
	                { className: 'col-sm-6' },
	                _react2.default.createElement(_sharedGroup2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sortablejs = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SimpleList = function (_React$Component) {
	    ...
	    function SimpleList() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SimpleList)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            items: [1, 2, 3, 4, 5, 6]
	    ...
	    _createClass(SimpleList, [{
	        key: 'render',
	        value: function render() {
	            var items = this.state.items.map(function (text, index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SharedGroup = function (_React$Component) {
	    ...
	    function SharedGroup() {
	        ...
	        _classCallCheck(this, SharedGroup);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(SharedGroup)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            items: _this.props.items
	        }, _temp), _possibleConstructorReturn(_this, _ret);
	    }

	    _createClass(SharedGroup, [{
	        key: 'render',
	        value: function render() {
	            var items = this.state.items.map(function (text, index) {
	                return _react2.default.createElement(
